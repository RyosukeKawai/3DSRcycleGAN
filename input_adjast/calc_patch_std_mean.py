...
def main():
    ...
    for i in range(len(coordinate)):
        ...
        if i==0: df.to_csv('{}/lr_std_mean.csv'.format(result_dir), index=False ,encoding='utf-8', mode='a')
    ...
    for j in range(len(coordinate2)):
        ...
        if j == 0: df.to_csv('{}/lr_std_mean.csv'.format(result_dir), index=False, encoding='utf-8', mode='a')
